...
1. **Офлайн вариант:**
	...
	- Выполнить команду `opkg install "/путь_к_пакету/antiscan_1.3_all.ipk"`
2. **Онлайн вариант:**
	- Выполнить команду `opkg install https://github.com/dimon27254/antiscan/releases/download/1.3/antiscan_1.3_all.ipk"`
